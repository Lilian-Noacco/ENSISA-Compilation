package fr.uha.hassenforder.cage.turtle.compiler.processor;
...
import fr.uha.hassenforder.cage.turtle.compiler.reader.ttl.Parser;
import fr.uha.hassenforder.cage.turtle.compiler.reader.ttl.Scanner;
import fr.uha.hassenforder.cage.turtle.compiler.renderer.LogoRender;
import fr.uha.hassenforder.cage.turtle.compiler.view.GraphicTurtle;
import fr.uha.hassenforder.cage.turtle.compiler.writer.IWriter;
import fr.uha.hassenforder.cage.turtle.compiler.writer.svg.SVGWriter;
...
public class Processor {
	...
	public void saveToFile(String outputFileName) {
		if (context != null && ! context.hasErrors()) {
			IWriter writer = new SVGWriter(context);
