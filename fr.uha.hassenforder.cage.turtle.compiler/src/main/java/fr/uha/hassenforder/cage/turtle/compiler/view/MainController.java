...
import fr.uha.hassenforder.cage.turtle.compiler.io.IO;
import fr.uha.hassenforder.cage.turtle.compiler.processor.Processor;
...
public class MainController {
    ...
    private void onSaveAs() {
		String outputFileName = stripFilename(inputFileName.get())+".svg";
		processor.saveToFile(outputFileName);
	}
