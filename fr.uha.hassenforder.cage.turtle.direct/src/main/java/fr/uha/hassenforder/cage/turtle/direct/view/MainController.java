package fr.uha.hassenforder.cage.turtle.direct.view;
...
import fr.uha.hassenforder.cage.turtle.direct.io.IO;
import fr.uha.hassenforder.cage.turtle.direct.processor.Processor;
...
public class MainController {
    ...
    private void onDefault(ActionEvent event) {
		try (
			InputStream inputStream = getClass().getResourceAsStream("direct.ttl");
    ...
    private void onProcess() {
		...
		processor.readAndDraw(new StringReader(inputContent.get()), drawingArea);
