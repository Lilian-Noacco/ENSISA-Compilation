package fr.uha.noacco.cage.xon;
...
import fr.uha.noacco.cage.xon.dump.XonDumper;
import fr.uha.noacco.cage.xon.model.xon.Node;
import fr.uha.noacco.cage.xon.reader.XonReader;
import fr.uha.noacco.cage.xon.transformer.Xon2Json;
	...
	static public void main(String argv[]) {    
		try {
			...
			if (argv.length == 1) {
				...
				name = "./fr.uha.noacco.cage.xon/test.txt";
			}
			Main main = new Main();
			File file = new File(".");
